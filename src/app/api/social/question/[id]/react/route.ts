...
import { addReactionToResponse } from "@/lib/supabase/social-store";
import { checkRateLimit } from "@/lib/rate-limit";
import type { ReactionPayload } from "@/lib/supabase/types";

const VALID_REACTION_TYPES = ["love", "praying", "amen", "fire"] as const;
...
export async function POST(
  ...
  try {
    ...
    const updated = addReactionToResponse(id, type);
    ...
    console.error("[Question React POST] Error:", error);
    return NextResponse.json(
